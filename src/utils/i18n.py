...
STRINGS = {
    "en": {
        ...
        "wizard_welcome_text": "ElderlyMonitor protects your computer from scams.\n\nLet's take a quick tour of what this app does to keep you safe.",
        "wizard_feat1_title": "🛡️ Remote Access Protection",
        "wizard_feat1_text": "ElderlyMonitor constantly checks if someone is trying to control your PC remotely using tools like AnyDesk or TeamViewer.\n\nIf it detects suspicious remote control, it will warn you immediately.",
        "wizard_feat2_title": "🏦 Banking Security",
        "wizard_feat2_text": "Whenever you open a banking or payment website, ElderlyMonitor ensures no one is spying on your screen.\n\nIf a remote connection is active during a bank login, it will trigger a critical alert.",
        "wizard_feat3_title": "🚨 Panic Button",
        "wizard_feat3_text": "If you ever feel in danger or suspect a scam, just press Ctrl+Alt+S.\n\nThis will instantly close all browsers and remote access tools, disconnecting the scammer.",
    ...
    "it": {
        ...
        "wizard_welcome_text": "ElderlyMonitor protegge il tuo computer dalle truffe.\n\nFacciamo un rapido tour per capire come questa app ti terrà al sicuro.",
        "wizard_feat1_title": "🛡️ Protezione Accesso Remoto",
        "wizard_feat1_text": "ElderlyMonitor controlla costantemente se qualcuno sta cercando di controllare il tuo PC a distanza usando programmi come AnyDesk o TeamViewer.\n\nSe rileva un controllo remoto sospetto, ti avviserà immediatamente.",
        "wizard_feat2_title": "🏦 Sicurezza Bancaria",
        "wizard_feat2_text": "Ogni volta che apri un sito bancario o di pagamenti, ElderlyMonitor si assicura che nessuno stia spiando il tuo schermo.\n\nSe una connessione remota è attiva durante l'accesso alla banca, farà scattare un allarme critico.",
        "wizard_feat3_title": "🚨 Pulsante di Emergenza",
        "wizard_feat3_text": "Se ti senti in pericolo o sospetti una truffa, premi Ctrl+Alt+S.\n\nQuesto chiuderà all'istante tutti i browser e gli strumenti di accesso remoto, disconnettendo il truffatore.",
